...
export async function connect(){
    ...
    if (global.connection && global.connection.state !== 'disconnected')
     ...
     // pega um wrapper do mysql que da um suporte ao promisses
...
export async function selectBairro(){
    const conn = await connect();
    const [rows] = await conn.query('SELECT * FROM bairro');
    return await rows;
}

export async function insertBairro(){
    const conn = await connect();
...
export async function deleteBairro(){
    const conn = await connect();
...
export async function selectCinemaBairro(bairro){
    const conn = await connect();
...
export async function selectRegiaoAdmBairro(RA){
    const conn = await connect();
...
export async function selectMediaIDH(){
    const conn = await connect();
...
export async function selectMediaIDHBairro(){
    const conn = await connect();
...
export async function selectSumFamiliaBairro(){
    const conn = await connect();
...
export async function selectBairroSemCinema(){
    const conn = await connect();
...
export async function selectFamiliaBairroCinema(){
    const conn = await connect();
...
export async function selectBairroFamiliaDados(){
    const conn = await connect();
...
// inner join tudo
export async function selectTudo(){
    const conn = await connect();
